...
description: Deep research specialist for blog content. Conducts web searches, collects images and YouTube links from URLs, creates structured research briefs with source verification and media extraction for aStory blog posts.
